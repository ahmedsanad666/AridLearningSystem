...
export default {
  ...
  methods: {
    ...
    loadCurrentQ() {
      console.log(this.updatedQCounter);
      if (this.updatedQCounter > this.allQ.length - 1) {
        this.currentMood = "showResult";
        return;
      }
      this.currentQuestoin = this.allQ[this.updatedQCounter];
      const data = {
        counter: this.updatedQCounter,
        time: this.currentQuestoin.time,
      };
  ...
  watch: {
    QCounter(val) {
      this.updatedQCounter = val;
      console.log(this.updatedQCounter, "qcounter method");
      // this.loadCurrentQ();
      this.nextQ();
      this.loadCurrentQ();
    },
