...
export default {
  ...
  async LoadLessons(context ){
    ...
    async deleteCourse(_,payload){
      const response = await fetch(`https://localhost:7243/arid/courses/${payload}`,
      {
        method:'DELETE',
      });
    ...
    async UpdateCourse(_,payload){
      const response = await fetch(`https://localhost:7243/arid/courses/${payload.id}`,
      {
        method:'PUT',  
        headers: {
    ...
    const response = await fetch(`https://localhost:7243/arid/coursechapter/${payload}`,
    {
      method:'DELETE',
    });
  ...
  async UpdateChapter(_,payload){
    const response = await fetch(`https://localhost:7243/arid/coursechapter/${payload.id}`,
    {
      method:'PUT',  
      headers: {
        'Content-Type': 'application/json', // Set the Content-Type header to application/json
...
async deletelesson(_,payload){
  const response = await fetch(`https://localhost:7243/arid/lesson/${payload}`,
  {
    method:'DELETE',
  });
...
async UpdateLesson(_,payload){
  const response = await fetch(`https://localhost:7243/arid/lesson/${payload.id}`,
  {
    method:'PUT',  
    headers: {
      'Content-Type': 'application/json', // Set the Content-Type header to application/json
...
async AddSlides(_,payload){
  ...
  const response = await fetch(`https://localhost:7243/arid/lesson/AddSlides`,
  {
    method:'POST',  
    headers: {
      'Content-Type': 'application/json', // Set the Content-Type header to application/json
...
async updateUserCourse(_,payload){
  const response = await fetch(`https://localhost:7243/arid/usercourse/${payload.id}`,
  {
    method:'PUT',  
    headers: {
      'Content-Type': 'application/json', // Set the Content-Type header to application/json
